...
class AngleFactory:
    ...
    def get_multiple_angles(self, source_point: str, dt: datetime) -> List[Angle]:
        return [self.get_single_angle(source_point, target_point, dt) for target_point in self.angle_targets[source_point]]
