...
def _get_vedic_values(
    ...
    for mp in horoscope.mgps:
        ...
        row = {
            "Name": mp.point,
            "": " R" if mp.direction == "R" else "",
            "Position": mp.vedic.zodiacal_position,
            "House": mp.vedic.house,
            "Ruler": mp.vedic.sign_ruler,
