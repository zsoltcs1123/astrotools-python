...
def _generate_transit_str(transit: Transit, points_filter: List[str] = []):
    ...
    for point in transit.natal_horoscope.mps:
        ...
        str += f"\n{point.base_position.point:<10}{float_to_zodiacal(point.base_position.lon.decimal):<10}{float_to_zodiacal(transit_point.base_position.lon.decimal):<10}{round(angle.circular_diff,3):<10}{transit_point.house(transit.natal_horoscope.cusps):<10}"
