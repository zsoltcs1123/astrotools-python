...
def get_positions_for_planet(planet: str, start_time: datetime, end_time: datetime) -> List[MappedPosition]:
...
def get_planet_decan_changes(planet: str, start_time: datetime, end_time: datetime) -> List[DecanChange]:
    return get_decan_changes(get_positions_for_planet(planet, start_time, end_time))
...
def main():
    ...
    aspects = get_all_aspects(planet, start_time, end_time, 240)
