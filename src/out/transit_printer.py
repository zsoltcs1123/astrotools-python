...
def _generate_transit_table_str(transit_table: TransitTable):
        ...
        for i, planet1 in enumerate(planets):
            for j, planet2 in enumerate(planets):
                ...
                angle = next((angle for angle in transit_table.angles[planet1] if angle.target.name == planet2), None)
        ...
        for i, planet1 in enumerate(planets):
            for j, planet2 in enumerate(planets):
                # Find the corresponding Angle or Aspect object
                aspect = next((aspect for aspect in transit_table.aspects[planet1] if aspect.angle.target.name == planet2), None)
